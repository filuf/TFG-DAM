...
import com.slotify.backend.spring.notification.useCases.GetSentNotificationsUseCase;
...
public class NotificationController {
    ...
    private final GetSentNotificationsUseCase getSentNotificationsUseCase;

    @GetMapping("sent")
    @PreAuthorize("hasAnyRole('USER','COMPANY')")
    public ResponseEntity<Page<NotificationSummary>> getSentNotifications(
        ...
        Page<NotificationSummary> sentNotifications = this.getSentNotificationsUseCase.getSentNotifications(
